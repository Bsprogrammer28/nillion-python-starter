...
async def main():
    ...
    # Create a secret named "DepositClient1" with any value, ex: 500
    new_secret = nillion.NadaValues(
        {
            "LoanClient2": nillion.SecretInteger(500),
        }
    )

    # Set the input party for the secret
    # The party name needs to match the party name that is storing "DepositClient1" in the program
    party_name = "Bank"
    ...
    # Add LoanClient2, the 2nd secret at computation time
    computation_time_secrets = nillion.NadaValues({"BankBalance": nillion.SecretInteger(10)})
